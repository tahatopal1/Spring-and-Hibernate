...
// Nothing different from DeleteCourseDemo.java class but show us the cascaded deleting on course-learner join table
public class GetAndDeleteCourseDemo {
